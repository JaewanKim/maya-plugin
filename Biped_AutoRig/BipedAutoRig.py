...
class BipedAutoRig():
    ...
    def fix_ctrl(self, args):
        ...
        cmds.setAttr('arm_lf_bind_shoulder_jnt_orientConstraint1.arm_lf_ik_shoulder_jntW0', 1)
        cmds.setAttr('arm_lf_bind_shoulder_jnt_orientConstraint1.arm_lf_fk_shoulder_jntW1', 0)
        cmds.setAttr('arm_lf_bind_elbow_jnt_orientConstraint1.arm_lf_ik_elbow_jntW0', 1)
        cmds.setAttr('arm_lf_bind_elbow_jnt_orientConstraint1.arm_lf_fk_elbow_jntW1', 0)
        cmds.setAttr('arm_lf_bind_wrist_jnt_orientConstraint1.arm_lf_ik_wrist_jntW0', 1)
        cmds.setAttr('arm_lf_bind_wrist_jnt_orientConstraint1.arm_lf_fk_wrist_jntW1', 0)
        ...
        cmds.setDrivenKeyframe('arm_lf_bind_shoulder_jnt_orientConstraint1.arm_lf_ik_shoulder_jntW0', cd='arm_lf_switch.IK_FK')
        cmds.setDrivenKeyframe('arm_lf_bind_shoulder_jnt_orientConstraint1.arm_lf_fk_shoulder_jntW1', cd='arm_lf_switch.IK_FK')
        cmds.setDrivenKeyframe('arm_lf_bind_elbow_jnt_orientConstraint1.arm_lf_ik_elbow_jntW0', cd='arm_lf_switch.IK_FK')
        cmds.setDrivenKeyframe('arm_lf_bind_elbow_jnt_orientConstraint1.arm_lf_fk_elbow_jntW1', cd='arm_lf_switch.IK_FK')
        cmds.setDrivenKeyframe('arm_lf_bind_wrist_jnt_orientConstraint1.arm_lf_ik_wrist_jntW0', cd='arm_lf_switch.IK_FK')
        cmds.setDrivenKeyframe('arm_lf_bind_wrist_jnt_orientConstraint1.arm_lf_fk_wrist_jntW1', cd='arm_lf_switch.IK_FK')
        ...
        cmds.setAttr('arm_lf_bind_shoulder_jnt_orientConstraint1.arm_lf_ik_shoulder_jntW0', 0)
        cmds.setAttr('arm_lf_bind_shoulder_jnt_orientConstraint1.arm_lf_fk_shoulder_jntW1', 1)
        cmds.setAttr('arm_lf_bind_elbow_jnt_orientConstraint1.arm_lf_ik_elbow_jntW0', 0)
        cmds.setAttr('arm_lf_bind_elbow_jnt_orientConstraint1.arm_lf_fk_elbow_jntW1', 1)
        cmds.setAttr('arm_lf_bind_wrist_jnt_orientConstraint1.arm_lf_ik_wrist_jntW0', 0)
        cmds.setAttr('arm_lf_bind_wrist_jnt_orientConstraint1.arm_lf_fk_wrist_jntW1', 1)
        cmds.setDrivenKeyframe('arm_lf_pv_ctrl_grp.visibility', cd='arm_lf_switch.IK_FK')
        cmds.setDrivenKeyframe('arm_lf_ik_wrist_jnt_ctrl_grp.visibility', cd='arm_lf_switch.IK_FK')
        cmds.setDrivenKeyframe('arm_lf_fk_shoulder_jnt_ctrl_grp.visibility', cd='arm_lf_switch.IK_FK')
        cmds.setDrivenKeyframe('arm_lf_bind_shoulder_jnt_orientConstraint1.arm_lf_ik_shoulder_jntW0', cd='arm_lf_switch.IK_FK')
        ...
        cmds.setAttr('arm_rt_bind_shoulder_jnt_orientConstraint1.arm_rt_ik_shoulder_jntW0', 1)
        cmds.setAttr('arm_rt_bind_shoulder_jnt_orientConstraint1.arm_rt_fk_shoulder_jntW1', 0)
        cmds.setAttr('arm_rt_bind_elbow_jnt_orientConstraint1.arm_rt_ik_elbow_jntW0', 1)
        cmds.setAttr('arm_rt_bind_elbow_jnt_orientConstraint1.arm_rt_fk_elbow_jntW1', 0)
        cmds.setAttr('arm_rt_bind_wrist_jnt_orientConstraint1.arm_rt_ik_wrist_jntW0', 1)
        cmds.setAttr('arm_rt_bind_wrist_jnt_orientConstraint1.arm_rt_fk_wrist_jntW1', 0)
        ...
        cmds.setDrivenKeyframe('arm_rt_bind_shoulder_jnt_orientConstraint1.arm_rt_ik_shoulder_jntW0', cd='arm_rt_switch.IK_FK')
        cmds.setDrivenKeyframe('arm_rt_bind_shoulder_jnt_orientConstraint1.arm_rt_fk_shoulder_jntW1', cd='arm_rt_switch.IK_FK')
        cmds.setDrivenKeyframe('arm_rt_bind_elbow_jnt_orientConstraint1.arm_rt_ik_elbow_jntW0', cd='arm_rt_switch.IK_FK')
        cmds.setDrivenKeyframe('arm_rt_bind_elbow_jnt_orientConstraint1.arm_rt_fk_elbow_jntW1', cd='arm_rt_switch.IK_FK')
        cmds.setDrivenKeyframe('arm_rt_bind_wrist_jnt_orientConstraint1.arm_rt_ik_wrist_jntW0', cd='arm_rt_switch.IK_FK')
        cmds.setDrivenKeyframe('arm_rt_bind_wrist_jnt_orientConstraint1.arm_rt_fk_wrist_jntW1', cd='arm_rt_switch.IK_FK')
        ...
        cmds.setAttr('arm_rt_bind_shoulder_jnt_orientConstraint1.arm_rt_ik_shoulder_jntW0', 0)
        cmds.setAttr('arm_rt_bind_shoulder_jnt_orientConstraint1.arm_rt_fk_shoulder_jntW1', 1)
        cmds.setAttr('arm_rt_bind_elbow_jnt_orientConstraint1.arm_rt_ik_elbow_jntW0', 0)
        cmds.setAttr('arm_rt_bind_elbow_jnt_orientConstraint1.arm_rt_fk_elbow_jntW1', 1)
        cmds.setAttr('arm_rt_bind_wrist_jnt_orientConstraint1.arm_rt_ik_wrist_jntW0', 0)
        cmds.setAttr('arm_rt_bind_wrist_jnt_orientConstraint1.arm_rt_fk_wrist_jntW1', 1)
        cmds.setDrivenKeyframe('arm_rt_pv_ctrl_grp.visibility', cd='arm_rt_switch.IK_FK')
        cmds.setDrivenKeyframe('arm_rt_ik_wrist_jnt_ctrl_grp.visibility', cd='arm_rt_switch.IK_FK')
        cmds.setDrivenKeyframe('arm_rt_fk_shoulder_jnt_ctrl_grp.visibility', cd='arm_rt_switch.IK_FK')
        cmds.setDrivenKeyframe('arm_rt_bind_shoulder_jnt_orientConstraint1.arm_rt_ik_shoulder_jntW0', cd='arm_rt_switch.IK_FK')
        ...
        cmds.setAttr('leg_lf_bind_tight_jnt_orientConstraint1.leg_lf_ik_tight_jntW0', 1)
        cmds.setAttr('leg_lf_bind_tight_jnt_orientConstraint1.leg_lf_fk_tight_jntW1', 0)
        cmds.setAttr('leg_lf_bind_shin_jnt_orientConstraint1.leg_lf_ik_shin_jntW0', 1)
        cmds.setAttr('leg_lf_bind_shin_jnt_orientConstraint1.leg_lf_fk_shin_jntW1', 0)
        cmds.setAttr('leg_lf_bind_ankle_jnt_orientConstraint1.leg_lf_ik_ankle_jntW0', 1)
        cmds.setAttr('leg_lf_bind_ankle_jnt_orientConstraint1.leg_lf_fk_ankle_jntW1', 0)
        cmds.setAttr('leg_lf_bind_ball_jnt_orientConstraint1.leg_lf_ik_ball_jntW0', 1)
        cmds.setAttr('leg_lf_bind_ball_jnt_orientConstraint1.leg_lf_fk_ball_jntW1', 0)
        ...
        cmds.setDrivenKeyframe('leg_lf_bind_tight_jnt_orientConstraint1.leg_lf_ik_tight_jntW0', cd='leg_lf_switch.IK_FK')
        cmds.setDrivenKeyframe('leg_lf_bind_tight_jnt_orientConstraint1.leg_lf_fk_tight_jntW1', cd='leg_lf_switch.IK_FK')
        cmds.setDrivenKeyframe('leg_lf_bind_shin_jnt_orientConstraint1.leg_lf_ik_shin_jntW0', cd='leg_lf_switch.IK_FK')
        cmds.setDrivenKeyframe('leg_lf_bind_shin_jnt_orientConstraint1.leg_lf_fk_shin_jntW1', cd='leg_lf_switch.IK_FK')
        cmds.setDrivenKeyframe('leg_lf_bind_ankle_jnt_orientConstraint1.leg_lf_ik_ankle_jntW0', cd='leg_lf_switch.IK_FK')
        cmds.setDrivenKeyframe('leg_lf_bind_ankle_jnt_orientConstraint1.leg_lf_fk_ankle_jntW1', cd='leg_lf_switch.IK_FK')
        cmds.setDrivenKeyframe('leg_lf_bind_ball_jnt_orientConstraint1.leg_lf_ik_ball_jntW0', cd='leg_lf_switch.IK_FK')
        cmds.setDrivenKeyframe('leg_lf_bind_ball_jnt_orientConstraint1.leg_lf_fk_ball_jntW1', cd='leg_lf_switch.IK_FK')
        ...
        cmds.setAttr('leg_lf_bind_tight_jnt_orientConstraint1.leg_lf_ik_tight_jntW0', 0)
        cmds.setAttr('leg_lf_bind_tight_jnt_orientConstraint1.leg_lf_fk_tight_jntW1', 1)
        cmds.setAttr('leg_lf_bind_shin_jnt_orientConstraint1.leg_lf_ik_shin_jntW0', 0)
        cmds.setAttr('leg_lf_bind_shin_jnt_orientConstraint1.leg_lf_fk_shin_jntW1', 1)
        cmds.setAttr('leg_lf_bind_ankle_jnt_orientConstraint1.leg_lf_ik_ankle_jntW0', 0)
        cmds.setAttr('leg_lf_bind_ankle_jnt_orientConstraint1.leg_lf_fk_ankle_jntW1', 1)
        cmds.setAttr('leg_lf_bind_ball_jnt_orientConstraint1.leg_lf_ik_ball_jntW0', 0)
        cmds.setAttr('leg_lf_bind_ball_jnt_orientConstraint1.leg_lf_fk_ball_jntW1', 1)
        cmds.setDrivenKeyframe('leg_lf_pv_ctrl_grp.visibility', cd='leg_lf_switch.IK_FK')
        cmds.setDrivenKeyframe('foot_lf_ik_ctrl_grp.visibility', cd='leg_lf_switch.IK_FK')
        cmds.setDrivenKeyframe('leg_lf_fk_tight_jnt_ctrl_grp.visibility', cd='leg_lf_switch.IK_FK')
        cmds.setDrivenKeyframe('leg_lf_bind_tight_jnt_orientConstraint1.leg_lf_ik_tight_jntW0', cd='leg_lf_switch.IK_FK')
        ...
        cmds.setAttr('leg_rt_bind_tight_jnt_orientConstraint1.leg_rt_ik_tight_jntW0', 1)
        cmds.setAttr('leg_rt_bind_tight_jnt_orientConstraint1.leg_rt_fk_tight_jntW1', 0)
        cmds.setAttr('leg_rt_bind_shin_jnt_orientConstraint1.leg_rt_ik_shin_jntW0', 1)
        cmds.setAttr('leg_rt_bind_shin_jnt_orientConstraint1.leg_rt_fk_shin_jntW1', 0)
        cmds.setAttr('leg_rt_bind_ankle_jnt_orientConstraint1.leg_rt_ik_ankle_jntW0', 1)
        cmds.setAttr('leg_rt_bind_ankle_jnt_orientConstraint1.leg_rt_fk_ankle_jntW1', 0)
        cmds.setAttr('leg_rt_bind_ball_jnt_orientConstraint1.leg_rt_ik_ball_jntW0', 1)
        cmds.setAttr('leg_rt_bind_ball_jnt_orientConstraint1.leg_rt_fk_ball_jntW1', 0)
        ...
        cmds.setDrivenKeyframe('leg_rt_bind_tight_jnt_orientConstraint1.leg_rt_ik_tight_jntW0', cd='leg_rt_switch.IK_FK')
        cmds.setDrivenKeyframe('leg_rt_bind_tight_jnt_orientConstraint1.leg_rt_fk_tight_jntW1', cd='leg_rt_switch.IK_FK')
        cmds.setDrivenKeyframe('leg_rt_bind_shin_jnt_orientConstraint1.leg_rt_ik_shin_jntW0', cd='leg_rt_switch.IK_FK')
        cmds.setDrivenKeyframe('leg_rt_bind_shin_jnt_orientConstraint1.leg_rt_fk_shin_jntW1', cd='leg_rt_switch.IK_FK')
        cmds.setDrivenKeyframe('leg_rt_bind_ankle_jnt_orientConstraint1.leg_rt_ik_ankle_jntW0', cd='leg_rt_switch.IK_FK')
        cmds.setDrivenKeyframe('leg_rt_bind_ankle_jnt_orientConstraint1.leg_rt_fk_ankle_jntW1', cd='leg_rt_switch.IK_FK')
        cmds.setDrivenKeyframe('leg_rt_bind_ball_jnt_orientConstraint1.leg_rt_ik_ball_jntW0', cd='leg_rt_switch.IK_FK')
        cmds.setDrivenKeyframe('leg_rt_bind_ball_jnt_orientConstraint1.leg_rt_fk_ball_jntW1', cd='leg_rt_switch.IK_FK')
        ...
        cmds.setAttr('leg_rt_bind_tight_jnt_orientConstraint1.leg_rt_ik_tight_jntW0', 0)
        cmds.setAttr('leg_rt_bind_tight_jnt_orientConstraint1.leg_rt_fk_tight_jntW1', 1)
        cmds.setAttr('leg_rt_bind_shin_jnt_orientConstraint1.leg_rt_ik_shin_jntW0', 0)
        cmds.setAttr('leg_rt_bind_shin_jnt_orientConstraint1.leg_rt_fk_shin_jntW1', 1)
        cmds.setAttr('leg_rt_bind_ankle_jnt_orientConstraint1.leg_rt_ik_ankle_jntW0', 0)
        cmds.setAttr('leg_rt_bind_ankle_jnt_orientConstraint1.leg_rt_fk_ankle_jntW1', 1)
        cmds.setAttr('leg_rt_bind_ball_jnt_orientConstraint1.leg_rt_ik_ball_jntW0', 0)
        cmds.setAttr('leg_rt_bind_ball_jnt_orientConstraint1.leg_rt_fk_ball_jntW1', 1)
        cmds.setDrivenKeyframe('leg_rt_pv_ctrl_grp.visibility', cd='leg_rt_switch.IK_FK')
        cmds.setDrivenKeyframe('foot_rt_ik_ctrl_grp.visibility', cd='leg_rt_switch.IK_FK')
        cmds.setDrivenKeyframe('leg_rt_fk_tight_jnt_ctrl_grp.visibility', cd='leg_rt_switch.IK_FK')
        cmds.setDrivenKeyframe('leg_rt_bind_tight_jnt_orientConstraint1.leg_rt_ik_tight_jntW0', cd='leg_rt_switch.IK_FK')
